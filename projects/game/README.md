...
- Big map that has maybe 20 places you can go
- Purple oceans
- Main land where you start cant leave at first then after get “telaportr thingi” you can leave to island A front here you can go form A - B -  C or A - B - D
- From C you can go forth to 8 more island using break point (telleportyer) with on having a fork to one path that goes to the final island and one that goes to a dead end after 2 islands
- The last ten islands are split floating; the only way to get them is if you get certain items like a grapple or something while few can be accessed by the break point.
 more medieval but a bit more moderns
- Spellbound lands
- The castle and villages are called “orders”
...
# Tech or Gear
 Break Point is a triangle shape small almost flat that is actually hundreds of interlocking triangular pieces imbued with magic they take the form of a port and allow you travel. here is magic everyone can harness and use though without practice it is difficult to control and can cause many terrible outcomes. There is also ancient magic that only few understand and can work. Then there is the force and grapple the grapple is a too the player can use to latch onto high surfaces and bring himself up and the force is a use of his aciant magic.
